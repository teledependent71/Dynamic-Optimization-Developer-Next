...
import booksPageInitialPaths4636aResource from '../../../resources/books-page-initial-paths-4636a'
import booksPageInitialProps2168fResource from '../../../resources/books-page-initial-props-2168f'
...
export async function getStaticPaths() {
  const response = await booksPageInitialPaths4636aResource({})
...
export async function getStaticProps(context) {
  const response = await booksPageInitialProps2168fResource({
    ...context?.params,

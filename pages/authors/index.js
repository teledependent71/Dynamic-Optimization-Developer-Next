...
import authorsPageInitialProps420e7Resource from '../../resources/authors-page-initial-props-420e7'
  ...
  return (
    <>
      <div className="authors1-container">
        <Head>
          <title>Authors1 - Dynamic Optimization Developer</title>
          <meta
            property="og:title"
            content="Authors1 - Dynamic Optimization Developer"
          />
        </Head>
        <DataProvider
...
export async function getStaticProps(context) {
  const response = await authorsPageInitialProps420e7Resource({
    ...context?.params,
  })
  return {
    props: {
